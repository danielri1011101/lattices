...
/* package sNTarks-0.1.0.0 */
#ifndef VERSION_sNTarks
#define VERSION_sNTarks "0.1.0.0"
#endif /* VERSION_sNTarks */
#ifndef MIN_VERSION_sNTarks
#define MIN_VERSION_sNTarks(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sNTarks */
...
#define CURRENT_COMPONENT_ID "sNTarks-0.1.0.0-inplace-sNTarks"
